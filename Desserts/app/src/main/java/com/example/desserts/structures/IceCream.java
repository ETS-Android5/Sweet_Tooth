...
public class IceCream extends Edible {
     ...
     */
    public IceCream(String name, long Id, double cost, String basicDescription, List<String> ingredientsContained, List<String> dietsSuitableFor, long numberViewed, int peopleServed, int scoops, boolean cone, String category) {
